...
+
----
bin/kc.[sh|bat] build --db postgres --db-url-host mypostgres --db-username myuser --db-password change_me
bin/kc.[sh|bat] start --optimized
----
+

These commands include the minimum settings needed to connect to the database.
