...
It is also possible to configure the database when https://www.keycloak.org/server/importExport[importing or exporting Realms] or (starting with release 26):
----
